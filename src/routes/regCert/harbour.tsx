...
import { columns } from '@/config/columnsConfig/regCert/harbour';
import { fieldsConfig } from '@/config/fieldsConfig/regCert/harbour';
import { sampleData } from '@/mockupdata/regCert/harbour';
...
export const Route = createFileRoute('/regCert/harbour')({

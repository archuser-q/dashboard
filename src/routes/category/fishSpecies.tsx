import { columns, type DataType } from '@/configuration/columnsConfig/fishSpecies';
import { data } from '@/mockupdata/category/fishSpecies';
...
import { fieldsConfig } from '@/configuration/fieldsConfig/fishSpecies';
import { useDrawerStore } from '@/store/useDrawerStore';

export const Route = createFileRoute('/category/fishSpecies')({

...
export const columns = [
  ...
  {title: 'Số giấy đăng ký',dataIndex: 'regisNumber',key: 'regisNumber',},
  {title: 'Cơ quan cấp đăng ký',dataIndex: 'regisOffice',key: 'regisOffice',},
  {title: 'Ngành nghề khai thác',dataIndex: 'occupation',key: 'occupation',
